#!/usr/bin/env python3
"""Deterministic viewer generator for the messy-csv-parser worked example.
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Render the messy-csv-parser experiment viewer.")
