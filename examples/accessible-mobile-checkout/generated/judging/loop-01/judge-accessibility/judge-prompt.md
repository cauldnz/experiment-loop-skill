# Preserved judge instruction

You are the approved independent blind `judge-accessibility` for Loop 01 of an accessibility-first mobile checkout Experiment. Operate and judge three blinded candidates. Do not edit candidates, read Track/model identities, read other judge output, or create a new candidate.
...
Blinded evidence bundles, evaluate in this exact order:
1. `.experiments\accessible-mobile-checkout\generated\judging\blind-loop-01\candidate-a`
2. `.experiments\accessible-mobile-checkout\generated\judging\blind-loop-01\candidate-b`
3. `.experiments\accessible-mobile-checkout\generated\judging\blind-loop-01\candidate-c`
...
Write scope ONLY:
`.experiments\accessible-mobile-checkout\generated\judging\loop-01\judge-accessibility\**`
No setup, harness, blind bundle, candidate, top Manifest/Viewer, dependency, network, git, commit, PR, or promotion changes.
...
- `candidate-a.json/.md`, `candidate-b.json/.md`, `candidate-c.json/.md` with actual model `gpt-5.6-terra`, exact scores, evidence refs relative to generated root, lens findings, strengths, defects, uncertainty, and one evidence-backed Loop 02 recommendation;
...
- `pairwise.json/.md` comparing A/B, B/C, A/C in that order, preferences and confidence, without guessing identity;
